...
const Banner = () => {
  ...
  <div className="justify-center text-center my-6">
            <p className="font-extrabold text-3xl text-black">Books to freshen <br /> up your bookshelf</p>
   <button className="btn bg-[#23BE0A] text-white mt-10">View The List</button>
 </div>
          
          <figure ><img className="h-48 rounded-lg" src="https://i.ibb.co/r0v740p/pngwing-1.png" alt="Movie"/></figure>
</div>
</div>
